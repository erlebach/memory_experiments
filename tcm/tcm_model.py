...
class TCM_A:
    ...
    def _initialize_memory(self, list_length):
        """Initializes memory stores for a new list."""
    ...
    def _update_context(self, t_in, beta):
        """
        Updates the context vector according to the core TCM equation.[1]
    ...
    def encode_list(self, item_indices, distractor_duration=0):
        """
        Encodes a list of items, updating context and associative matrices.
    ...
    def recall(self, list_length: int, time_limit: int = 1000) -> "list[int]":
        """Simulates the free recall process using a leaky, competitive accumulator.
        ...
        for _ in range(time_limit):
            ...
            item_activations = self.context @ (self.params['gamma_tf'] * self.M_exp_tf).T
            ...
            delta_x = self.params['tau'] * (item_activations - self.params['kappa'] * accumulators - inhibition) + noise
            ...
            if np.any(accumulators > self.params['threshold']):
                ...
                if winner_idx not in self.recalled_items_indices:
                    ...
                    t_in_retrieval = (self.params['gamma_ft'] * retrieved_context_exp + 
    ...
    def recognize(self, item_idx: int) -> tuple[float, bool]:
        """Simulates a simple recognition judgment.
        ...
        total_activation = (self.params['gamma_tf'] * activation_exp + 
